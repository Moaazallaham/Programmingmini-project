...
public class foodcategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = (TextView) findViewById(R.id.foodquestion);
        ...
        try {
            ...
            XPathExpression expr = xpath.compile("//CATEGORIES//FOOD//M" + String.valueOf(index));
    ...
    public void foodnext() {
        ...
        foodbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent foodnext = new Intent(foodcategory.this,foodcategory.class);

                startActivity(foodnext);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_settings:
                Intent settings = new Intent(foodcategory.this, Settings.class);
                startActivity(settings);
                break;

            case R.id.action_info:

                Intent information = new Intent(foodcategory.this, Infopage.class);

                startActivity(information);
                break;
            case R.id.action_homepage:
                Intent homebutton = new Intent(foodcategory.this,Homepage.class);
